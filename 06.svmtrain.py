...
grid_search_results = pd.read_csv('datasets/gridcvsvm.csv')

best_params = grid_search_results.loc[grid_search_results['mean_test_score'].idxmax(), ['param_c', 'param_gamma']]
...
X_test
svc = SVC()
svc.set_params(C=best_params['param_c'], gamma=best_params['param_gamma'])
...
results_df.to_csv('result/cv_svc.csv', index=False)
single_result.to_csv('result/single_svc.csv', index=False)
